...
async def optimize_resume(
    ...
    try:
        ...
        optimization_result = await orchestrator.optimize_cv_for_job(
            cv_text=resume.original_content,
        ...
        return OptimizeResponse(
            ...
            optimized_resume=optimization_result.get("optimized_cv", ""),
            ats_score=optimization_result.get("ats_score", 0.0),
...
async def score_resume(
    ...
    try:
        ...
        resume_text = request.resume_text or resume.original_content
...
async def generate_cover_letter(
    ...
    try:
        ...
        resume_content = request.resume_content or resume.original_content
