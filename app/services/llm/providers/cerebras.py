...
class CerebrasProvider(BaseLLMProvider):
    ...
    def validate_config(self) -> bool:
        ...
        if not self.config.api_base:
            raise ValueError("Cerebras API base URL is required")
    ...
    async def chat_completion(
        ...
        **kwargs
        ...
        """Generate chat completion using Cerebras AI."""
        ...
        try:
            ...
            # Calculate cost (Cerebras pricing)
            cost_usd = None
            if tokens_used:
                ...
                model_pricing = pricing.get(self.config.model_name, pricing['gpt-oss-120b'])
                cost_usd = (
                    (tokens_used['prompt_tokens'] / 1000000) * model_pricing['input'] +
                    (tokens_used['completion_tokens'] / 1000000) * model_pricing['output']
                )
    ...
    async def completion(
        ...
        **kwargs
        ...
        """Generate text completion using Cerebras AI."""
