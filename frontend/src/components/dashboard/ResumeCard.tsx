...
import {
	...
	useDownloadOriginalResume,
	useDownloadResume,
} from "@/hooks/useResumes";
import { ResumeStatus } from "@/types/enums";
import type { Resume } from "@/types/resume";
import { format } from "date-fns";
import { FileDown, Mail, Sparkles, Trash2 } from "lucide-react";
				...
				<div className="flex items-start justify-between">
					...
					{onStatusChange ? (
						<Select
							value={resume.status}
							onValueChange={(v) =>
								onStatusChange(resume.id, v as ResumeStatus)
							}
						>
					...
					<Button
						...
						title={
							resume.isOptimized
								...
								: "Resume must be optimized first"
						}
					>
